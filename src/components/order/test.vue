  ...
  <el-form ref="form" :model="form" label-width="80px" class="shop-form">
    <div class="shop-formtwo">
      ...
      <el-form-item label="店铺名称 :">
        <el-input :placeholder="data.shop_name"></el-input>
      </el-form-item>
      ...
      <el-form-item label="商家类型 :">
        <el-select v-model="form.region" placeholder="自营商家">
          <el-option label="自营商家" value="shanghai"></el-option>
          <el-option label="入驻商家" value="beijing"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="公司名称 :">
        <el-input :placeholder="data.company_name"></el-input>
      </el-form-item>
      <el-form-item label="联系人 :">
        <el-input :placeholder="data.contacts_name"></el-input>
      </el-form-item>
      <el-form-item label="联系电话 :">
        <el-input :placeholder="data.contact_number"></el-input>
      </el-form-item>
      <el-form-item label="详细地址 :">
        <el-input :placeholder="data.shop_address"></el-input>
      </el-form-item>
    </div>
    <!-- 弹窗 -->
    <el-dialog
